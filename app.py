...
try:
    ...
    CV2_AVAILABLE = False
    cv2 = None
    warnings.warn("OpenCV not available, image processing will be limited")
...
def main():
    ...
    with col1:
        ...
        if uploaded_file:
            ...
            display_img = Image.fromarray(image if len(image.shape) == 3 else image)
        ...
        if st.session_state.analysis_complete and st.session_state.analysis_results:
            ...
            if landmarks is not None and CV2_AVAILABLE:
                ...
                if cv2 is not None:
                    ...
                    st.image(comparison_rgb, caption="虚拟试妆效果", use_container_width=True)
